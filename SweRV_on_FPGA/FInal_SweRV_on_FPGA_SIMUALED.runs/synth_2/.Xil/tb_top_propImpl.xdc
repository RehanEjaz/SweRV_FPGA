...
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { rst_ind }]; #IO_L18N_T2_35 Sch=led0_b
set_property src_info {type:XDC file:2 line:21 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { porst_ind }]; #IO_L21P_T3_DQS_35 Sch=led1_g
