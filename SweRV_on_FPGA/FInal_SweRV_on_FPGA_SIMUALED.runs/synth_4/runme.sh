...
HD_PWD='/home/rehan/MERL/FPGA_EMU/FInal_SweRV_on_FPGA_SIMUALED/FInal_SweRV_on_FPGA_SIMUALED.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log tb_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_top.tcl
