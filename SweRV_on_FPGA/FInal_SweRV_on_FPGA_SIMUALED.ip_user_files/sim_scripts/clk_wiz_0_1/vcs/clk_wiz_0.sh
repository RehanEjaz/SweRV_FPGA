...
#
# Generated by Vivado on Sun Jan 23 07:45:50 PKT 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../SweRV_on_FPGA.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../SweRV_on_FPGA.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/rehan/Downloads/FPGA_SWRV/SweRV_on_FPGA/SweRV_on_FPGA.cache/compile_simlib/vcs"
  fi
