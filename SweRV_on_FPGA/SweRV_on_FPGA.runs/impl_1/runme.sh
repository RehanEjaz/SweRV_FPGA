...
HD_PWD='/opt/Xilinx/Vivado/2018.2/bin/Only_SweRV_On_FPGA/Only_SweRV_On_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_top.tcl -notrace
